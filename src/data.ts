...
export const projects = [
  ...
  },
  {
    ...
    stack: ["React", "Vite", "TypeScript", "Tailwind CSS", "Framer Motion", "Agentic AI"],
    bullets: [
      ...
      "Leveraged <strong>Agentic AI</strong> and <strong>Agentic Coding</strong> tools to architect and rapidly develop the platform's features and UI.",
      "Designed a responsive, high-performance interface using <strong>React</strong>, <strong>TypeScript</strong>, and integrated fluid transitions via <strong>Framer Motion</strong>.",
    ],
  },
];
