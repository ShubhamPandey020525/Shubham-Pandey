        ...
        >
          ...
          {education.map((edu, i) => (
            <motion.div key={i} variants={fadeUp} transition={{ duration: 0.6 }} className="relative">
              <div className="absolute -left-12 w-10 h-10 bg-surface border-3 border-accent rounded-full flex items-center justify-center shadow-glow">
              ...
              <div className="glass-card p-7">
                ...
                <p className="text-slate-300 text-base">{edu.score}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>
