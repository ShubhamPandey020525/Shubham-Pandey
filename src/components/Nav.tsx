    ...
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
          ...
          {navLinks.map((link) => (
            ...
            >
              ...
              {((link.href === "#" && activeSection === "") || activeSection === link.href.slice(1)) && (
                <motion.span
                  layoutId="underline"
                  className="absolute bottom-0 left-0 right-0 h-1.5 bg-gradient-to-r from-accent to-accentAlt rounded-full"
                />
              )}
            </a>
          ))}
        ...
        <button
          ...
          className="md:hidden p-2 text-slate-900 hover:text-slate-900 transition-colors"
        >
